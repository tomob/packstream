...
let run_test_cases cases =
  let internal (s, v) =
    let bs = Bitstring.bitstring_of_string s in
    (* match (parse bs) with
...
let test_float _ctx =
  ...
  and examples = [1.23; 0.; -123.456] in
...
let test_incomplete_fails _ctx =
  let prefixes =
    [ (* Numbers *)
      ...
      "\xcb\x01\x02\x03";
      "\xcb\x01\x02\x03\x04";
      "\xcb\x01\x02\x03\x04\x05";
      "\xcb\x01\x02\x03\x04\x05\x06";
      "\xcb\x01\x02\x03\x04\x05\x06\x07";
      "\xc1";
      "\xc1\x01";
      "\xc1\x01\x02";
      "\xc1\x01\x02\x03";
      "\xc1\x01\x02\x03\x04";
      "\xc1\x01\x02\x03\x04\x05";
      "\xc1\x01\x02\x03\x04\x05\x06";
      "\xc1\x01\x02\x03\x04\x05\x06\x07";
      "\xcc";
      "\xcc\x01";
      "\xcc\x02\x00";
      "\xcd";
      ...
      "\x94\x01\x01\x01";
      "\x95\x01\x01\x01\x01";
      "\x96\x01\x01\x01\x01\x01";
      "\x97\x01\x01\x01\x01\x01\x01";
      "\x98\x01\x01\x01\x01\x01\x01\x01";
      "\x99\x01\x01\x01\x01\x01\x01\x01\x01";
      "\x9a\x01\x01\x01\x01\x01\x01\x01\x01\x01";
      "\x9b\x01\x01\x01\x01\x01\x01\x01\x01\x01\x01";
      "\x9c\x01\x01\x01\x01\x01\x01\x01\x01\x01\x01\x01";
